      ...
      {loading ? (
        ...
        <Container>
          <div style={{ marginTop: 50 }}>
            ...
            <p style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 30 }}>Pengajuan Bantuan Kacamata </p>
          </div>
          <div style={{ marginBottom: 50 }}>
            ...
            <Form>
              <Form.Group as={Row}>
                ...
                <Col sm="10">
                  <Form.Control type="text" value={data.data1} disabled={true} />
                </Col>
              </Form.Group>
              <Form.Group as={Row}>
                <Form.Label column sm="2">
                ...
                <Col sm="10">
                  <Form.Control type="text" value={data.data2} disabled={true} />
                </Col>
              </Form.Group>
              <Form.Group as={Row}>
                <Form.Label column sm="2">
                ...
                <Col sm="10">
                  <Form.Control type="text" value={data.data3} disabled={true} />
                </Col>
              </Form.Group>
              <Form.Group as={Row}>
                <Form.Label column sm="2">
                ...
                <Col sm="10">
                  <Form.Control type="text" value={data.data4} disabled={true} />
                </Col>
              </Form.Group>
              <Form.Group as={Row}>
                <Form.Label column sm="2">
                ...
                <Col sm="10">
                  <Form.Control type="text" value={data.data5} disabled={true} />
                </Col>
              </Form.Group>
              <Form.Group as={Row}>
                <Form.Label column sm="2">
