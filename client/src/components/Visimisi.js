        ...
        <Row>
          <div style={{ marginTop: 50 }}>
            ...
            <p>
              ...
              dan memiliki Kantor Perwakilan di wilayah Jawa Timur, Jawa Tengah, serta Jawa Barat
              dan Banten. Di awal pendirian, Yayasan diurus oleh suatu pengurus yang ditunjuk dan
              diangkat oleh salah satu Direktur Perhutani selaku Ketua Pembina.
              <br style={{ marginBottom: 10 }} />
              Pada tahun 2008, yayasan melakukan perubahan Anggaran Dasar yang sangat mendasar dalam
              rangka menyesuaikan dengan Undang-Undang Yayasan yang dikeluarkan oleh Pemerintah
              yaitu Undang-Undang No: 16 Tahun 2001, dan Undang-undang No 28 Tahun 2004. Perubahan
              Anggaran dasar ini menyangkut susunan organ yayasan dan memperluas kegiatan nya yaitu
              dibidang Sosial dan Kemanusiaan. Perubahan ini di legalkan dengan Akte Notaris Etty
              Purwaningsih SH, No: 08 Tanggal 24 September 2008.
              <br style={{ marginBottom: 10 }} />
              ...
              Perum Perhutani Jati Sejahtera (YKP3JS), serta penambahan kegiatan yaitu program
              bantuan pemilikan rumah dan program kesehatan.
            </p>
            <div style={{ marginTop: 50 }}>
            ...
            <ul className="time">
              <li>
                <motion.div
                  ...
                  whileHover={{ color: "#45fc03", scale: 1.2, rotate: 360 }}
                ...
                >
                  <motion.div className="time-heading" variants={item}>
                    <h4>Visi</h4>
                  </motion.div>
                  ...
                  <div className="time-body">
                    <p className="text-muted">
                      <ol style={{ marginLeft: -20 }}>
                        <li>
                          Mengembangkan peran yayasan dalam bidang pendidikan, perumahan dan
                          kesehatan secara berkualitas.
                        </li>
                        <li>
                          Berusaha meningkatkan kesejahteraan dengan membantu meringankan beban para
                          pesertanya.
                        </li>
                        <li>Menjadikan “nilai” yayasan sebagai harapan pesertanya.</li>
                        <li>
                          Bekerja berdasarkan nilai kebersamaan, saling merasakan dan saling
                          menghargai.
                        </li>
                      </ol>
                    </p>
